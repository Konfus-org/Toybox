...
namespace Tbx
{
    ...
    public:
        ...
        EXPORT static std::shared_ptr<IWindow> GetMainWindow();
        EXPORT static std::shared_ptr<IWindow> GetFocusedWindow();

        EXPORT static std::shared_ptr<IWindow> GetWindow(const UID& id);
        EXPORT static std::vector<std::shared_ptr<IWindow>> GetAllWindows();
