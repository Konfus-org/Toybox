...
/// </summary>
#define TBX_TRACE(msg, ...) Tbx::Log::Trace(msg __VA_OPT__(,) __VA_ARGS__)
...
/// </summary>
#define TBX_TRACE_DEBUG(msg, ...) Tbx::Log::Debug(msg __VA_OPT__(,) __VA_ARGS__)
...
/// </summary>
#define TBX_TRACE_INFO(msg, ...) Tbx::Log::Info(msg __VA_OPT__(,) __VA_ARGS__)
...
/// </summary>
#define TBX_TRACE_WARNING(msg, ...) Tbx::Log::Warn(msg __VA_OPT__(,) __VA_ARGS__)
...
/// </summary>
#define TBX_TRACE_ERROR(msg, ...) Tbx::Log::Error(msg __VA_OPT__(,) __VA_ARGS__)
...
/// </summary>
#define TBX_TRACE_CRITICAL(msg, ...) Tbx::Log::Critical(msg __VA_OPT__(,) __VA_ARGS__)
    ...
    /// </summary>
    #define TBX_TRACE_VERBOSE(msg, ...) Tbx::Log::Info(msg __VA_OPT__(,) __VA_ARGS__)
#else
    /// <summary>
    /// Logs verbose info for debugging IF verbose logging is enabled.
    ...
    #endif
    #define TBX_ASSERT(check, msg, ...) do { if(!(check)) { TBX_TRACE_CRITICAL(msg __VA_OPT__(,) __VA_ARGS__); TBX_DEBUG_BREAK(); } } while(0)
#else
    /// <summary>
    ...
    /// This is a good method to use to validate things.
    /// </summary>
    #define TBX_ASSERT(check, msg, ...) do { if(!(check)) { TBX_TRACE_CRITICAL(msg __VA_OPT__(,) __VA_ARGS__); } } while(0)
#endif
