#include "App.h"
#include "Tbx/App/Renderer/RendererAPI.h"
#include <Tbx/Core/Time/DeltaTime.h>
...
namespace Tbx
{
    ...
    void App::Launch(bool headless)
    {
        ...
        if (!_isHeadless)
        {
            ...
            _windowClosedEventId = Events::Subscribe<WindowClosedEvent>(TBX_BIND_CALLBACK(OnWindowClosed));
            _windowResizeEventId = Events::Subscribe<WindowResizedEvent>(TBX_BIND_CALLBACK(OnWindowResize));
    ...
    void App::ShutdownSystems()
    {
        ...
        Events::Unsubscribe(_windowClosedEventId);
