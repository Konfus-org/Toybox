...
namespace Tbx::Tests::Math
{
    ...
    TEST(
        QuaternionTests,
        OperatorMultiplicationQuaternionVector_RotatesVectorCorrectlyAroundYPositive)
    {
        // Arrange
    ...
    TEST(
        QuaternionTests,
        OperatorMultiplicationQuaternionVector_RotatesVectorCorrectlyAroundYNegative)
    {
        // Arrange
        Quaternion rotation = Quaternion::FromEuler(Vector3(0.0f, -90, 0.0f));
        Vector3 v(1.0f, 0.0f, 0.0f);
    ...
    TEST(
        QuaternionTests,
        OperatorMultiplicationVectorQuaternion_RotatesVectorCorrectlyAroundYPositive)
    {
        // Arrange
        Quaternion rotation = Quaternion::FromEuler(Vector3(0.0f, 90, 0.0f));
        Vector3 v(1.0f, 0.0f, 0.0f);
    ...
    TEST(
        QuaternionTests,
        OperatorMultiplicationVectorQuaternion_RotatesVectorCorrectlyAroundYNegative)
    {
        // Arrange
        Quaternion rotation = Quaternion::FromEuler(Vector3(0.0f, -90, 0.0f));
        Vector3 v(1.0f, 0.0f, 0.0f);
    ...
    TEST(QuaternionTests, MultiplyStaticMethodQuaternion_MultipliesCorrectly)
    {
        ...
        // Assert
        Quaternion expected =
            Quaternion::FromEuler(Vector3(45, 45, 0.0f)); // Equivalent combined rotation
        EXPECT_TRUE(Quaternion::IsEqualOrEquivalent(result, expected));
    }

    TEST(
        QuaternionTests,
        MultiplyStaticMethodQuaternionVector_RotatesVectorCorrectlyAroundYPositive)
    {
        // Arrange
    ...
    TEST(
        QuaternionTests,
        MultiplyStaticMethodVectorQuaternion_RotatesVectorCorrectlyAroundYPositive)
    {
        // Arrange
        Quaternion rotation = Quaternion::FromEuler(Vector3(0.0f, 90.0f, 0.0f));
        Vector3 v(1.0f, 0.0f, 0.0f);
