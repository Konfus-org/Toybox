...
namespace Tbx
{
    ...
    /// <summary>
    /// Coordinates render targets, windows, stage composition, and render resource caching for a
    /// frame.
    /// </summary>
    class TBX_EXPORT GraphicsPipeline
    {
      public:
        ...
        /// </summary>
        StageDrawData Prepare(
            GraphicsRenderer& renderer,
            const FullStageView& stageView,
            float aspectRatio);

        /// <summary>
        /// Clears the display using the given clear color, then draws the given stages to the
        /// display.
        /// </summary>
        void Draw(
            GraphicsRenderer& renderer,
        ...
        /// <summary>
        /// Determines if the given toy should be culled based on the given frustum and the render
        /// data.
        /// </summary>
        bool ShouldCull(
            const Ref<Toy>& toy,
