...
/// This is a good method to use to log info that is intended to be used to track down a bug with
/// the intention to be removed once the bug is solved.
/// </summary>
...
/// Msg will be written to a log file in release and a console in debug.
/// This is a good method to use to log info to the log that we want to track during runtime. Ex:
/// window resize, layers attached, shutdown triggered, etc...
/// </summary>
...
/// Msg will be written to a log file in release and a console in debug.
/// This is a good method to use to warn about something that might be problematic, but can likely
/// be ignored and app execution can continue without crashing. I.e. errors we can recover from.
/// </summary>
...
/// Msg will be written to a log file in release and a console in debug.
/// This is a good method to use if the app is in a state where it cannot continue i.e.
...
#define TBX_TRACE_CRITICAL(...) Tbx::Log::Critical(__VA_ARGS__)
    ...
    /// </summary>
    #define TBX_TRACE_VERBOSE(...) Tbx::Log::Verbose(__VA_ARGS__)
#else
    /// <summary>
    /// Logs verbose info for debugging IF verbose logging is enabled.
