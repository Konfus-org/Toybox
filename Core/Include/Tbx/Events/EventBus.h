...
namespace Tbx
{
    ...
    class TBX_EXPORT EventSuppressor
    {
      public:
        ...
        /// <summary>
        /// Decrements the global suppression counter, restoring normal event processing when the
    ...
    class TBX_EXPORT EventBus
    {
      public:
        ...
        /// <summary>
        /// Retrieves the callbacks registered for the supplied event key across this bus and its
        /// decorators.
        /// </summary>
      ...
      private:
        ...
        void CollectCallbacks(EventHash eventKey, std::unordered_map<Uid, EventCallback>& callbacks)
            const;
        void CollectCallbacksLocked(
            EventHash eventKey,
            std::unordered_map<Uid, EventCallback>& callbacks) const;
