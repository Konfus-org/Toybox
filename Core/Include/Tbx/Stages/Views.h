...
namespace Tbx
{
    ...
    class StageView
    {
      public:
        ...
        StageViewIterator begin()
        {
            return _viewVector.begin();
        }

        /// <summary>Returns an iterator one past the last toy in the view.</summary>
        StageViewIterator end()
        {
            return _viewVector.end();
        }

        /// <summary>Returns a const iterator to the first toy in the view.</summary>
        ConstStageViewIterator begin() const
        {
            return _viewVector.begin();
        }

        /// <summary>Returns a const iterator one past the last toy in the view.</summary>
        ConstStageViewIterator end() const
        {
            return _viewVector.end();
        }

        /// <summary>Returns a const iterator to the first toy in the view.</summary>
        ConstStageViewIterator cbegin() const
        {
            return _viewVector.cbegin();
        }

        /// <summary>Returns a const iterator one past the last toy in the view.</summary>
        ConstStageViewIterator cend() const
        {
            return _viewVector.cend();
        }
