...
namespace Tbx
{
    ...
    template <typename T>
    inline constexpr bool IsToy = std::
        is_base_of_v<Toy, typename std::remove_cv<typename std::remove_reference<T>::type>::type>;
    ...
    class TBX_EXPORT Toy
    {
      public:
        ...
        /// <summary>
        /// Adds a block of type <typeparamref name="T"/> or constructs a child toy and returns its
        /// shared reference.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether this toy contains a block of type <typeparamref name="T"/> or a child
        /// toy matching the request.
        /// </summary>
        template <typename T>
        bool Has() const
        {
        ...
        /// <summary>
        /// Removes the block of type <typeparamref name="T"/> or child toy from this toy if it
        /// exists.
        /// </summary>
        template <typename T>
        void Remove()
        ...
        /// <summary>
        /// Retrieves the shared reference to the block of type <typeparamref name="T"/> or the
        /// matching child toy.
        /// </summary>
        template <typename T>
        Ref<T> Get() const
        ...
        /// <summary>
        /// Attempts to retrieve a shared reference to the block of type <typeparamref name="T"/> or
        /// the matching child toy if present.
        /// </summary>
        template <typename T>
