...
namespace Tbx
{
    ...
    /// </summary>
    template <class T>
    concept IsLambda = std::is_class_v<std::remove_reference_t<T>>
    ...
    class Queryable : public Iterable<TItem>
    {
      public:
        ...
        /// <summary>
        /// Returns the first element of the sequence; if the sequence is empty, returns a default
        /// value.
        /// </summary>
        ...
        /// <summary>
        /// Returns the first element that satisfies <paramref name="predicate"/>; if none match,
        ...
        /// </summary>
        /// <typeparam name="TSelector">Lambda-like callable that accepts <c>const
        /// TItem&amp;</c>.</typeparam> <param name="selector">Projection function.</param>
        /// <returns>A new <c>Queryable&lt;Out&gt;</c> where Out is the selector's return
        /// type.</returns>
        ...
        /// <summary>
        /// Filters the sequence to elements that can be dynamically cast to <typeparamref
        /// name="TDerived"/>.
        /// </summary>
        ...
        auto OfType() const
        {
            ...
            else
            {
                static_assert(
                    !sizeof(TItem),
                    "Queryable::OfType requires pointer, Ref, WeakRef, or ExclusiveRef items");
            }
        }

      private:
        /// <summary>
        /// Default value returned when a query cannot produce an element (e.g., First on an empty
        /// sequence).
        /// </summary>
        TItem _default = {};
    };
