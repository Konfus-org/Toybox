...
{
    /// <summary>Configuration values used when initializing a camera controller.</summary>
    /// <remarks>
    /// Purpose: Defines movement, look, and startup orientation values for camera control.
    /// Ownership: Value type copied by the controller; no external ownership requirements.
    /// Thread Safety: Safe to copy across threads, but intended to configure main-thread use.
    /// </remarks>
    ...
    class CameraController : public InputController
    {
      public:
        ...
        /// </remarks>
        virtual void initialize(Entity camera, const CameraControllerSettings& settings);
      ...
      private:
        ...
        bool _allow_vertical_movement = false;
    };
}
