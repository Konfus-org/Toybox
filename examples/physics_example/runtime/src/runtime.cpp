...
namespace physics_example
{
    void PhysicsExampleRuntimePlugin::on_attach(tbx::IPluginHost& host)
    {
        ...
        camera.add_component<tbx::Transform>(
            tbx::Vec3(0.0F, 2.01F, 11.0F),
            tbx::Quat(tbx::Vec3(tbx::to_radians(-8.0F), 0.0F, 0.0F)),
            tbx::Vec3(1.0F));
    ...
    void PhysicsExampleRuntimePlugin::on_update(const tbx::DeltaTime& dt)
    {
    ...
    void PhysicsExampleRuntimePlugin::update_projectiles(const tbx::DeltaTime& dt)
    {
    ...
    void PhysicsExampleRuntimePlugin::spawn_projectile()
    {
        ...
        tbx::Vec3 shot_direction = camera_world_transform.rotation * tbx::Vec3(0.0F, 0.0F, -1.0F);
