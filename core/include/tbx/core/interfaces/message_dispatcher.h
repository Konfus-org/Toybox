...
namespace tbx
{
    ...
    /// @details
    /// Ownership: Constructed messages are owned by the dispatcher while executing; `post` takes
    ...
    /// @brief
    /// Purpose: Defines the interface for components that advance posted work, typically driven
...
#include "tbx/core/interfaces/message_dispatcher.inl"
