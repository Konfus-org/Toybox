...
namespace tbx
{
    ...
    const Mesh Mesh::CUBE = make_cube_mesh();
    const Mesh Mesh::SPHERE = make_sphere_mesh();
    const Mesh Mesh::CAPSULE = make_capsule_default_mesh();
    const Mesh Mesh::HALF_SPHERE = make_half_sphere_mesh();
}
