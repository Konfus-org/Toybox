...
namespace tbx
{
    ...
    void render(RenderContext& context)
    {
        ...
        internal::refresh_lighting(context.renderer, context.sandbox);
    ...
    {
        return {.name = "shadow", .render = &internal::render_shadow_pass};
    }

    RenderPass make_geometry_shadow_pass()
    {
        return {.name = "geometry", .render = &internal::render_geometry_pass};
    }

    RenderPass make_post_render_pass()
    {
        return {.name = "post", .render = &internal::render_post_pass};
    }

    RenderPass make_ui_render_pass()
    {
        return {.name = "ui", .render = &internal::render_ui_pass};
    }
