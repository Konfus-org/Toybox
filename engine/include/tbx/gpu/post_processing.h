...
namespace tbx
{
    ...
    struct TBX_API PostProcessing : Block
    {
        ...
        PostProcessing& set_shaders(std::vector<AssetHandle<ShaderSource>> value) { shaders = std::move(value); return *this; }
        PostProcessing& add_shader(AssetHandle<ShaderSource> value) { shaders.push_back(std::move(value)); return *this; }
    };
}
