...
namespace tbx
{
    ...
    struct TBX_API Ui : Block
    {
        ...
        Ui& set_vertex(AssetHandle<ShaderSource> value) { vertex = std::move(value); return *this; }
        Ui& set_fragment(AssetHandle<ShaderSource> value) { fragment = std::move(value); return *this; }
