...
namespace tbx
{
    ...
    struct TBX_DLL_EXPORT RenderState
    {
        ...
        FrameContext frame = {};
        // The render pipeline is part of the render state: the ordered pass list run every
        // frame. Seeded with make_default_render_graph() at boot; games mutate .passes.
