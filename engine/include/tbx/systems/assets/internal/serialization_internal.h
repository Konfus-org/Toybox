...
#define TBX_INTERNAL_CONCAT_INNER(Left, Right) Left##Right
#define TBX_INTERNAL_CONCAT(Left, Right) TBX_INTERNAL_CONCAT_INNER(Left, Right)
#define TBX_INTERNAL_AUTO_REGISTER(Name, Expression)                                               \
    /* NOLINTNEXTLINE(bugprone-throwing-static-initialization) */                                  \
    static const bool TBX_INTERNAL_CONCAT(Name, __COUNTER__) = []() noexcept                       \
    {                                                                                              \
