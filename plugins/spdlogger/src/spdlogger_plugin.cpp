...
namespace tbx::plugins::spdlogger
{
    ...
    public:
        ...
        void on_message(const Message& msg) override
        {
            ...
            switch (log->level)
            {
                case LogLevel::Info:     spdlog::info("{}:{} - {}", log->file, log->line, log->message); break;
                case LogLevel::Warning:  spdlog::warn("{}:{} - {}", log->file, log->line, log->message); break;
                case LogLevel::Error:    spdlog::error("{}:{} - {}", log->file, log->line, log->message); break;
                case LogLevel::Critical: spdlog::critical("{}:{} - {}", log->file, log->line, log->message); break;
            }
