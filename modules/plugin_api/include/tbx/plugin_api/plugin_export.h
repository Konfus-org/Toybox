#pragma once
            ...
            /// <summary>
            /// Purpose: Marks plugin public declarations for symbol export while building a plugin
            /// shared library.
        ...
        #else
            /// <summary>
            /// Purpose: Marks plugin public declarations for symbol import while consuming a plugin
            /// shared library.
            /// Ownership: Preprocessor macro with no ownership semantics.
            /// Thread Safety: Compile-time only.
            /// </summary>
