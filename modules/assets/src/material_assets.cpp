...
namespace tbx
{
    static std::shared_ptr<Material> create_material_data()
    {
        ...
        material.parameters.set("diffuse_map_strength", 1.0f);
        material.parameters.set("normal_map_strength", 1.0f);
        material.parameters.set("specular", 0.5f);
        material.parameters.set("specular_map_strength", 1.0f);
        material.parameters.set("shininess", 32.0f);
        material.parameters.set("shininess_map_strength", 1.0f);
        material.parameters.set("emissive", Color(1.0f, 0.0f, 1.0f, 1.0f));
        material.parameters.set("emissive_map_strength", 1.0f);
        material.parameters.set("occlusion", 1.0f);
        material.parameters.set("occlusion_map_strength", 1.0f);
