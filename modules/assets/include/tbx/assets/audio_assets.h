...
namespace tbx
{
    ...
    /// </summary>
    /// <remarks>
    /// Ownership: Returns an AssetPromise that shares ownership of the audio payload with
    ...
    /// </summary>
    /// <remarks>
    /// Ownership: Returns a shared audio payload owned by the caller. The payload is destroyed
