...
namespace tbx
{
    ...
    /// </summary>
    /// <remarks>
    /// Ownership: Returns an AssetPromise that shares ownership of the model payload with
    ...
    /// </summary>
    /// <remarks>
    /// Ownership: Returns a shared model payload owned by the caller. The payload is destroyed
