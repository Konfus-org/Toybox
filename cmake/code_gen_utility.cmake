...
function(tbx_codegen_generate_plugin_registration)
    ...
    tbx_enable_release_asset_bundling(TARGET ${TBX_CODEGEN_TARGET})
endfunction()
...
function(tbx_codegen_generate_builtin_asset_header)
    ...
    tbx_codegen_collect_python_sources(resource_codegen_sources)

    execute_process(
        COMMAND ${Python3_EXECUTABLE}
            "${PROJECT_SOURCE_DIR}/codegen/tbx_resource_codegen.py"
            --mode builtin-assets
            --source-root "${TBX_CODEGEN_SOURCE_ROOT}"
...
function(tbx_codegen_generate_material_instance_header)
    ...
    execute_process(
        COMMAND ${Python3_EXECUTABLE}
            ...
            --source-root "${TBX_CODEGEN_SOURCE_ROOT}"
            --output "${TBX_CODEGEN_OUTPUT_FILE}"
            --namespace "${TBX_CODEGEN_NAMESPACE}"
